...
#SBATCH --job-name=reidsbs-ibn
#SBATCH --output=reid_sbs-%j.out 
...
python tools/infer-baseline-architectures.py --start 72 --end 90 --output_path "/WAVE/projects/dmlab-sd/MCPTJKCV/" &
wait